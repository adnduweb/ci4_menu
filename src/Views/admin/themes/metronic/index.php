                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu dropdown-menu-right">
                                            <ul class="navi flex-column navi-hover py-2">
                                                <?php if ($item->id != '1') { ?>
                                                    <li class="navi-item">
                                                        <a class="navi-link" href="/<?= CI_SITE_AREA; ?>/public/menus/delete/<?= $item->id; ?>"><i class="la la-trash"></i> <?= lang('Core.delete'); ?></a>
                                                    </li>
                                                <?php } ?>
                                                <li class="navi-item">
                                                    <a class="navi-link" href="/<?= CI_SITE_AREA; ?>/public/menus/edit/<?= $item->id; ?>"><i class="la la-edit"></i><?= lang('Core.edit'); ?></a>
                                                </li>
                                            </ul>
                                        </div>
                                    </div>
                                    ...
                                    <div class="checkbox-list">
                                            <?php foreach ($modules['Adnduweb\Ci4_page']->items as $module) { ?>
                                                <label class="checkbox">
                                                    <input name="page-menu[<?= $modules['Adnduweb\Ci4_page']->id_module; ?>][<?= $module->getIdItem(); ?>]" value="<?= base64_encode(serialize($module->getNameAllLang())); ?>" data-method="/" data-id="<?= $module->getIdItem(); ?>" data-module="Adnduweb\Ci4_page" type="checkbox" kl_vkbd_parsed="true"> 
                                                    <input type="hidden" name="id_page" value="<?= $menu_item->id; ?>" />
                                                    <span></span><?= ucfirst($module->getBName()); ?>
                                                </label>
