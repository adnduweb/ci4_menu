...
namespace Spreadaurora\ci4_menu\Commands;
...
class Publish extends BaseCommand
{
     ...
     * @var string
     */
    protected $name = 'ci4_menu:publish';
     ...
     * @var string
     */
    protected $usage = 'ci4_menu:publish';
    ...
    protected function publishModules()
    {
        ...
        $this->copydir($this->sourcePath,APPPATH . '/Modules/ci4_menu');
