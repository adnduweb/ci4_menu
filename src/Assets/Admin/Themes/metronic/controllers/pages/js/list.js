"use strict";
var KTAppPagesListDatatable = function() {
    var t;
    return {
        init: function() {
            t = $("#kt_apps_pages_list_datatable").KTDatatable({
                data: {
                    type: "remote",
                    source: {
                        read: {
                        ...
                        $.ajax({
                            ...
                            success: function(result, status, xhr) {
                                ...
                                if (xhr.status == 200) {
                                    ...
                                    $("#kt_apps_pages_list_datatable").KTDatatable().reload();
                                }
                            }
                        })
                    } else {
